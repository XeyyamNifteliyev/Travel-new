...
- **Supabase** (Auth, DB 22 cədvəl, Realtime chat)
...
│   ├── country.ts                    → Country, VisaInfo, VisaDocument, VisaCountryData
│   ├── user.ts                       → Profile
...
**Migration faylları:** `supabase/migrations/001..011`
